  ...
  <div class="modal-card">
    ...
    <section class="modal-card-body">
      ...
      <div class="field">
          ...
          <div class="control">
            <input class="input" :class="{'is-danger':errors.name}" type="text" placeholder="Contact Name" v-model="list.name">
          </div>
    ...
    methods: {
      ...
      save(){
        axios.post('/phonebook',this.$data.list).then((response)=> {
          this.close()
          this.$parent.phoneList.push(response.data)
          this.$parent.phoneList.sort(function(a,b){
            if(a.name > b.name)
            {
              return 1;
            }
